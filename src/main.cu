    ...
    if(SOA) {
        ...
        if(CONSTANT_MEMORY) {
            ...
            for (int i = 0; i < ITER; i++) {
                ...
                convolutionConstantMemorySoA<<<dimGrid, dimBlock>>>(device_imageDataR, device_imageDataG, device_imageDataB,
                                                           device_outputDataR, device_outputDataG, device_outputDataB,
                                                           imageWidth, imageHeight);
